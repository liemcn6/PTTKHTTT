    ...
    <div class="row py-3 ps-3 pe-4">
        <div class="col-4">
            <div class="item-images">
                <img class="img-fluid" src="${shoeItem.image}">
            </div>
        </div>
        <div class="col-8">
            <div class="item-info">
                <h3 class="item-info__title fw-normal text-capitalize">${shoeItem.name}</h3>
                <div class="item-info__price bg-light p-3 fs-3 text-primary mt-4">
                    <span class="item-info__price--old"><custom:currencyFormat amount="${shoeItem.price}" currencyFormat="vi"/></span>
                    <span class="item-info__price--new"><custom:currencyFormat amount="${shoeItem.price - shoeItem.price*(shoeItem.discount/100)}" currencyFormat="vi"/></span>
                    <span class="item-info__price--discount">${shoeItem.discount}% GIẢM</span>
                </div>
            ...
            <div class="shadow-sm">
                ...
                <div class="item-detail-desc text-uppercase  p-4 bg-white">
                    ...
                    <div class="item-detail-desc__content px-3 mt-4">
                        <p class="text-wrap">${shoeItem.description}</p>
                    </div>
                </div>
            </div>
        </div>
